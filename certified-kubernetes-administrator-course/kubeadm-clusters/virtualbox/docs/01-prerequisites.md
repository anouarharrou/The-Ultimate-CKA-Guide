...
Should you have issues deploying bridge networking, please raise a [bug report](https://github.com/kodekloudhub/The-Ultimate-CKA-Guide/issues) and include all details including the output of `vagrant up`.
